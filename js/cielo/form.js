...
jQuery("#onestepcheckout-place-order-button").click(function() {
    cieloTresClean();
});
...
function cieloTresClean() {
    jQuery(".jp-card-cvc").html('');
    jQuery(".jp-card-number").html('');
    jQuery(".jp-card-name").html('');
    jQuery(".jp-card-expiry").html('');
}